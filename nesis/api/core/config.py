...
default = {
    ...
    "rag": {
        ...
        "mode": os.environ.get("NESIS_API_RAG_MODE", "ingest"),
        "extractions": {
            "store": {
                "table": os.environ.get("NESIS_API_EXTRACTIONS_STORE_TABLE")
                or "document_store",
                "url": os.environ.get("NESIS_API_EXTRACTIONS_STORE_URL")
                or os.environ.get("NESIS_API_DATABASE_URL"),
            }
        },
    },
    "memcache": {
