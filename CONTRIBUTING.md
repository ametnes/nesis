...
1. To make a contribution, fork this repository.
2. Ensure any install or build dependencies are removed before the end of the layer when doing a 
   build.

3. Make your changes on a branch in your forked repository with these guidelines.
    1. Write clear code.
    2. Comment on your changes.
    3. Add unit tests for your changes.
4. Create a PR with these guidelines
...
5. If necessary, update the README.md with details of your changes, this includes new environment 
...
reported by contacting the project team at nesis@ametnes.com. All
